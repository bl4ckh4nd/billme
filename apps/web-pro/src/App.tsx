...
import { createProHttpBillmeApi } from './api';
import { createBrowserNativeFallback } from './api/createBrowserNativeFallback';

const SESSION_STORAGE_KEY = 'billme.web-pro.session.v1';
const API_URL_STORAGE_KEY = 'billme.web-pro.api-url.v1';
const DEFAULT_API_URL = (import.meta.env.VITE_SERVER_API_URL as string | undefined) ?? undefined;
    ...
    () => ({
      ...
      createApi: ({ baseUrl, token, onAuthFailure, onRequestClose }) =>
        createProHttpBillmeApi({
          ...
          fallback: createBrowserNativeFallback(onRequestClose),
        }),
