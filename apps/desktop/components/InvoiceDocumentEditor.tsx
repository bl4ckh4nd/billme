  ...
  return (
    <div className="flex h-full w-full bg-canvas overflow-hidden">
        ...
        >
                        ...
                        <div className="mt-4 grid grid-cols-1 gap-3">
                          <div>
                            ...
                            <select
                              ...
                              className="w-full bg-surface-muted border border-border rounded-lg p-2.5 text-sm font-medium focus:ring-2 focus:ring-accent outline-none"
                            >
                ...
                <div className="space-y-4 animate-enter" style={{ animationDelay: '200ms' }}>
                        ...
                        <div className="flex items-center gap-2">
                            <div className="flex items-center gap-1">
                                ...
                                <button
                                    ...
                                    className="text-xs font-bold bg-canvas hover:bg-surface-muted disabled:opacity-40 disabled:cursor-not-allowed text-foreground px-2 py-1 rounded-lg transition-colors duration-150 ease-out flex items-center gap-1"
                    ...
                    <div className="space-y-3">
                        {formData.items.length === 0 && (
                            <p className="py-5 text-center text-muted text-sm">
                                Noch keine Positionen — füge eine Position hinzu.
                            </p>
                        )}
                            ...
                            <div key={idx} className="bg-surface border border-border rounded-xl p-3 shadow-sm hover:border-accent transition-colors duration-150 ease-out group animate-enter" style={{ animationDelay: `${200 + idx * 50}ms` }}>
                                <div className="flex gap-2 mb-2">
                                    ...
                                    <button 
                                        ...
                                        className="text-muted hover:text-error p-1 transition-colors duration-150 ease-out"
                                    >
                                        <Trash2 size={14} />
                                    </button>
                                </div>
                                <div className="grid grid-cols-4 gap-2">
                                    <div>
                                        ...
                                        <input
                                            ...
                                            className="w-full bg-surface-muted rounded-lg px-2 py-1 text-sm tabular-nums outline-none"
                                        />
                                    </div>
                                    <div>
                                    ...
                                    <div>
                                        ...
                                        <div className="text-right text-sm font-bold pt-1 tabular-nums">
            ...
            {/* Actions */}
            <div className="p-6 border-t border-border bg-white animate-enter" style={{ animationDelay: '450ms' }}>
                <button
                    onClick={() => {
                      setSaveError(null);
                    ...
                    className="w-full bg-accent text-accent-foreground font-bold py-3 rounded-xl hover:bg-accent-hover transition-[background-color,border-color,color,box-shadow,opacity,transform,width] duration-200 ease-out flex items-center justify-center gap-2 shadow-lg shadow-accent/20 active:scale-95"
                >
                    <Save size={18} />
