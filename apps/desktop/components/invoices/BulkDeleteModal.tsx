      ...
      <div className="bg-white rounded-3xl w-full max-w-xl shadow-2xl overflow-hidden flex flex-col animate-scale-in">
        <div className="p-6 border-b border-border-subtle flex justify-between items-center bg-surface-muted">
          <div>
            ...
            <p className="text-sm text-muted">{selectedCount} Einträge ausgewählt</p>
          </div>
          <button
            onClick={handleClose}
        ...
        <div className="p-6 space-y-4">
          ...
          <div>
            ...
            <textarea
              ...
              className="w-full bg-surface-muted border border-border rounded-lg p-4 text-sm outline-none focus:ring-2 focus:ring-accent resize-none"
            />
          </div>
        </div>
