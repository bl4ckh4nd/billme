        ...
        <div className="p-6">
          ...
          {isLoadingMatches ? (
            ...
            <div className="bg-surface rounded-lg border border-border p-8 text-center">
              ...
              <p className="text-muted font-medium mb-2">Keine passenden Rechnungen gefunden</p>
              ...
              {matchData.suggestions.map((suggestion, idx) => {
                ...
                return (
                  <div
                    ...
                    className="bg-surface rounded-lg border-2 border-border hover:border-info transition-[background-color,border-color,color,box-shadow,opacity,transform,width] duration-150 ease-out p-4 animate-enter"
                  ...
                  >
                    ...
                    <button
                      onClick={() =>
                        onLink(selectedTransaction.id, suggestion.invoice.id)
                      }
