...
export const NumbersTab: React.FC<NumbersTabProps> = ({ settings, updateNested }) => {
    ...
    <div className="max-w-2xl space-y-8 animate-enter">
      ...
      <div className="bg-surface-muted rounded-xl p-6 border border-border-subtle">
        <div className="flex justify-between items-start mb-6">
          ...
          <div className="bg-surface px-3 py-1 rounded-md border border-border shadow-sm">
            <span className="text-xs font-bold text-muted uppercase mr-2">Vorschau:</span>
            <span className="font-mono font-bold tabular-nums">{nextInvoicePreview}</span>
          </div>
        </div>
          ...
          <div>
            <div className="flex items-center gap-2 mb-2">
              ...
              <div className="group relative">
                ...
                <div className="absolute bottom-full left-1/2 -translate-x-1/2 mb-2 w-48 bg-foreground text-white text-xs p-2 rounded pointer-events-none opacity-0 group-hover:opacity-100 transition-opacity z-10">
            ...
            <input
              ...
              className="w-full bg-surface border border-border rounded-lg p-3 font-mono text-sm focus:ring-2 focus:ring-accent outline-none transition-shadow duration-200 ease-out"
            />
          </div>
          <div>
            ...
            <input
              ...
              className="w-full bg-surface border border-border rounded-lg p-3 font-mono text-sm tabular-nums focus:ring-2 focus:ring-accent outline-none transition-shadow duration-200 ease-out"
            />
          </div>
        </div>
        <div>
          ...
          <input
            ...
            className="w-full accent-black h-2 bg-canvas rounded-md appearance-none cursor-pointer"
          />
      ...
      <div className="bg-surface-muted rounded-xl p-6 border border-border-subtle opacity-70 hover:opacity-100 transition-opacity duration-200 ease-out">
        <div className="flex justify-between items-start mb-6">
          <h4 className="font-bold flex items-center gap-2">
      ...
      <div className="bg-surface-muted rounded-xl p-6 border border-border-subtle opacity-70 hover:opacity-100 transition-opacity duration-200 ease-out">
        <div className="flex justify-between items-start mb-6">
          ...
          <div className="bg-surface px-3 py-1 rounded-md border border-border shadow-sm">
            <span className="text-xs font-bold text-muted uppercase mr-2">Vorschau:</span>
            <span className="font-mono font-bold tabular-nums">{nextCustomerPreview}</span>
          </div>
        </div>
        <div className="grid grid-cols-2 gap-4 mb-4">
          <div>
