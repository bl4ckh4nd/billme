      ...
      <div className="bg-surface border-2 border-border-subtle rounded-xl p-6 space-y-6">
        ...
        <div className="flex flex-col sm:flex-row gap-3 items-center">
          <button
            ...
            className="px-5 py-3 rounded-xl font-bold bg-surface border border-border hover:bg-surface-muted transition-colors duration-200 ease-out w-full sm:w-auto"
          >
            Verbindung testen
          </button>
