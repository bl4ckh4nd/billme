...
export const accounts = sqliteTable('accounts', {
  ...
  // Pro adds this column; the default keeps the shared schema compatible with Lite databases.
  defaultSkrAccountNumber: text('default_skr_account_number').notNull().default(''),
  type: text('type').notNull(),
