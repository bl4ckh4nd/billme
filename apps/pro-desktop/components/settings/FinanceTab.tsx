        ...
        <div className="space-y-4">
          <div>
            ...
            <input
              ...
              className="w-full bg-surface border border-border rounded-lg p-3 text-sm focus:ring-2 focus:ring-accent outline-none transition-shadow duration-150 ease-out"
            />
          </div>
          <div className="grid grid-cols-2 gap-4">
            <div>
              ...
              <input
                ...
                className="w-full bg-surface border border-border rounded-lg p-3 text-sm font-mono focus:ring-2 focus:ring-accent outline-none transition-shadow duration-150 ease-out"
              />
            </div>
            <div>
      ...
      <div className="grid grid-cols-2 gap-6">
        <div>
          ...
          <input
            ...
            className="w-full bg-surface-muted border border-border rounded-lg p-4 font-medium focus:ring-2 focus:ring-accent outline-none transition-shadow duration-150 ease-out"
          />
        </div>
        <div>
