...
export const PaymentModal: React.FC<PaymentModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4">
      <div className="w-full max-w-lg rounded-3xl bg-surface shadow-xl overflow-hidden">
        <div className="flex items-center justify-between px-6 py-5 border-b border-border-subtle">
          ...
          <button
            onClick={handleClose}
            className="w-10 h-10 rounded-full bg-canvas hover:bg-surface-muted flex items-center justify-center transition-colors ease-out duration-150"
            title="Schließen"
          >
            <X size={18} />
          </button>
