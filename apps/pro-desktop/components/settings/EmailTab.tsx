      ...
      <div className="bg-surface border border-border rounded-xl p-6">
        ...
        <div className="flex gap-3">
          <button
            ...
            className={`flex-1 p-4 rounded-xl border-2 transition-[background-color,border-color,color,box-shadow,transform,opacity] ease-out ${
        ...
        <div className="bg-surface border border-border rounded-xl p-6 space-y-4">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              ...
              <input
                ...
                className="w-full bg-surface-muted border border-border rounded-lg p-3 text-sm font-medium focus:ring-2 focus:ring-accent outline-none transition-shadow duration-150 ease-out"
              />
            </div>
            <div>
              ...
              <input
                ...
                placeholder="587"
                className="w-full bg-surface-muted border border-border rounded-lg p-3 text-sm font-medium tabular-nums focus:ring-2 focus:ring-accent outline-none transition-shadow duration-150 ease-out"
              />
            </div>
          </div>
          <div>
          ...
          <div>
            <button
              ...
              className="px-4 py-2 bg-info text-white rounded-lg hover:bg-info/90 disabled:opacity-50 disabled:cursor-not-allowed transition-colors duration-150 ease-out"
            >
