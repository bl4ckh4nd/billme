    ...
    return (
        <div className="h-full flex flex-col gap-6 animate-enter pb-8 overflow-y-auto">
            ...
            <div className="flex justify-between items-center">
                <button onClick={onBack} className="flex items-center gap-2 text-muted hover:text-foreground font-bold transition-colors ease-out duration-150">
                    <ArrowLeft size={20} />
                ...
                <div className="flex gap-2">
                    <button
                        ...
                        className="px-3 py-1.5 bg-black text-white rounded-lg text-xs font-bold hover:bg-dark-1 transition-colors ease-out duration-150 flex items-center gap-2"
                    >
                    ...
                    <button
                        ...
                        className="px-4 py-2 bg-surface border border-border text-foreground rounded-full text-xs font-bold hover:bg-surface-muted transition-colors ease-out duration-150 flex items-center gap-2"
                    >
                        <Plus size={14} /> Neues Angebot
                    </button>
                    <button
                        onClick={onEdit}
                        className="w-10 h-10 border border-border rounded-full flex items-center justify-center hover:bg-surface-muted transition-colors ease-out duration-150"
                    >
                        <Edit3 size={16} />
                    </button>
                    <button
                        ...
                        className="w-10 h-10 border border-border rounded-full flex items-center justify-center hover:bg-error-bg transition-colors ease-out duration-150 text-error"
                    >
                        <Trash2 size={16} />
                    </button>
                </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    ...
                    <div className="space-y-2">
                        {sortedInvoices.length > 0 ? sortedInvoices.map((inv, idx) => (
                            <button
                                ...
                                className="group w-full text-left flex items-center justify-between p-4 rounded-xl border border-border-subtle hover:border-foreground hover:bg-surface-muted transition-[background-color,border-color,color,box-shadow,opacity,transform,width] ease-out duration-150 cursor-pointer animate-enter"
                ...
                <div className="flex flex-col gap-6">
                        ...
                        <div className="space-y-3">
                            {selectedClient.projects.map(p => (
                                <button
                                    ...
                                    className="w-full text-left p-4 bg-surface-muted rounded-xl border border-border-subtle hover:bg-canvas transition-colors ease-out duration-150"
                    ...
                    <div className="bg-surface rounded-xl p-6 border border-border flex-1 animate-enter delay-300">
                        ...
                        <p className="text-sm text-foreground leading-relaxed bg-warning-bg p-4 rounded-xl border border-warning-border">
