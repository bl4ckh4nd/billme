    ...
    <>
      ...
      {open && createPortal(
        <div
          ...
          className="bg-surface text-foreground rounded-2xl shadow-2xl border border-border p-4 min-w-[260px] animate-scale-in"
        ...
        >
            ...
            {fields.map((f) => (
              <div key={f.key}>
                ...
                <input
                  ...
                  className="w-full bg-surface-muted border border-border rounded-lg px-3 py-2 text-sm font-mono font-bold text-foreground outline-none focus:ring-2 focus:ring-accent focus:border-accent"
                />
              </div>
            ))}
          </div>
          <button
            ...
            className="mt-3 w-full py-2 bg-black text-white rounded-xl text-xs font-bold hover:bg-dark-2 transition-colors ease-out"
          >
            Speichern
          </button>
        </div>,
