    ...
    <div className="w-1/2 border-r border-border overflow-y-auto">
      <div className="p-4">
        <button
          ...
          className={`px-4 py-2 rounded-lg font-medium text-sm transition-[background-color,border-color,color,box-shadow,opacity,transform,width] duration-150 ease-out ${toggleVisibilityClass}`}
        >
      ...
      {filteredTransactions.length === 0 ? (
        ...
        <div className="p-4 space-y-2">
          {filteredTransactions.map((transaction, idx) => {
            ...
            let rowClass = 'border-border hover:border-muted/30 hover:shadow-sm';
            if (isSelected) {
            ...
            return (
              <div
                ...
                className={`p-4 rounded-lg border-2 cursor-pointer transition-[background-color,border-color,color,box-shadow,opacity,transform,width] duration-150 ease-out animate-enter ${rowClass}`}
