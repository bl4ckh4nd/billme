                    ...
                    <div className="col-span-5 flex items-end justify-end gap-2">
                        <button
                            ...
                            className={`px-3 py-1.5 rounded-full text-xs font-bold border transition-colors ${
                                ad.isDefaultBilling ? 'bg-black text-white border-black' : 'bg-surface text-foreground border-border hover:bg-surface-muted'
                            }`}
                        >
                        ...
                        <button
                            ...
                            className={`px-3 py-1.5 rounded-full text-xs font-bold border transition-colors ${
                                ad.isDefaultShipping ? 'bg-black text-white border-black' : 'bg-surface text-foreground border-border hover:bg-surface-muted'
                            }`}
                        >
