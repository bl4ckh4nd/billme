...
export const DunningLevelPreviewModal = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm">
      <div className="bg-surface rounded-2xl shadow-2xl w-[95%] max-w-4xl max-h-[90vh] flex flex-col">
        {/* Header */}
          ...
          <div className="bg-surface rounded-lg shadow-xl border border-border overflow-hidden max-w-3xl mx-auto">
            ...
            <div className="px-6 py-8 bg-surface" style={{ fontFamily: 'ui-sans-serif, system-ui, sans-serif' }}>
              ...
              <div className="mt-8 pt-6 border-t border-border">
                <p className="text-foreground text-sm">Mit freundlichen Grüßen</p>
        ...
        <div className="flex items-center justify-end gap-3 px-6 py-4 border-t border-border bg-surface-muted">
          <button
            onClick={onClose}
            className="px-6 py-2.5 bg-foreground text-background rounded-lg hover:bg-dark-1 transition-colors ease-out font-semibold text-sm shadow-sm"
          >
            Schließen
          </button>
        </div>
