...
export const ClientEditorModal: React.FC<ClientEditorModalProps> = ({
    ...
    <div className="flex flex-col flex-1 min-h-0">
        <div className="p-6 border-b border-border flex items-center justify-between">
            ...
            <button
                onClick={onClose}
                className="w-10 h-10 rounded-full hover:bg-surface-muted transition-colors duration-150 ease-out flex items-center justify-center"
            >
                <X size={18} />
            </button>
        </div>
            ...
            <section>
               ...
               <div>
                   ...
                   <input
                       ...
                       className="w-full bg-surface-muted border border-border rounded-lg p-3 text-sm font-mono outline-none focus:ring-2 focus:ring-accent transition-shadow duration-150 ease-out"
                   />
               </div>
                <div className="col-span-2">
                    ...
                    <input
                       ...
                       className="w-full bg-surface-muted border border-border rounded-lg p-3 text-sm font-medium outline-none focus:ring-2 focus:ring-accent transition-shadow duration-150 ease-out"
                   />
               </div>
               <div>
               ...
               <div>
                   ...
                   <select
                       value={draft.status}
                       onChange={(e) => onDraftChange({ ...draft, status: e.target.value as any })}
                       className="w-full bg-surface-muted border border-border rounded-lg p-3 text-sm font-medium outline-none focus:ring-2 focus:ring-accent transition-shadow duration-150 ease-out"
                   >
        ...
        <div className="p-6 border-t border-border bg-surface-muted rounded-b-2xl">
            ...
            <button
                onClick={onClose}
                className="px-4 py-2 bg-surface border border-border text-foreground rounded-full text-xs font-bold hover:bg-surface-muted transition-colors duration-150 ease-out"
            >
                Abbrechen
            </button>
            <button
