...
interface PaymentsCardProps {
  ...
  onSaveRecentPaymentsLimit: (limit: number) => void;
  ...
  return (
    <div className="bg-accent rounded-xl p-8 text-black min-h-[350px] flex flex-col shadow-sm relative overflow-hidden group animate-enter delay-200 premium-hover">
        ...
        <div className="flex justify-between items-center mb-6 relative z-10">
            ...
            <div className="flex items-center gap-2">
                <DashboardSettingsPopover
                  ...
                  onSave={(v) => onSaveRecentPaymentsLimit(v.recentPaymentsLimit)}
        ...
        <div className="space-y-2 relative z-10">
            {payments.length === 0 ? (
              <div className="p-4 bg-white/40 backdrop-blur-sm rounded-xl border border-white/20 text-sm font-bold opacity-70">
              ...
              payments.slice(0, recentPaymentsLimit).map((item) => (
                <div
                  ...
                  className="flex items-center justify-between p-3 bg-white/40 backdrop-blur-sm rounded-xl border border-white/20 hover:bg-white/60 transition-colors cursor-pointer hover:scale-[1.02]"
                  onClick={() =>
