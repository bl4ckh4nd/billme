            ...
            <div className="flex bg-surface-muted rounded-lg p-1 border border-border">
              {[19, 7, 0].map((rate) => (
                <button
                  ...
                  className={`flex-1 py-2 rounded-md text-xs font-bold transition-[background-color,border-color,color,box-shadow,opacity,transform,width] duration-150 ease-out ${
        ...
        <div className="flex gap-4">
          {editingArticle && (
            <button
              ...
              className="px-4 py-4 rounded-xl bg-surface border border-border text-error hover:bg-error-bg hover:border-error/30 transition-colors duration-150 ease-out"
            >
              <Trash2 size={20} />
            </button>
          )}
          <button
            onClick={onSubmit}
            disabled={isSaving}
            className="flex-1 bg-foreground text-accent py-3 rounded-xl font-bold flex items-center justify-center gap-2 hover:bg-dark-1 active:scale-95 transition-[background-color,border-color,color,box-shadow,opacity,transform,width] duration-150 ease-out disabled:opacity-50 disabled:cursor-not-allowed shadow-sm"
          >
            <Check size={18} />
