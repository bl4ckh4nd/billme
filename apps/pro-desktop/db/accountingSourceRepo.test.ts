...
const createDb = (legacySourceKey = false): Database.Database => {
  ...
  db.exec(`
    ...
    VALUES ('invoice-journal-1', 'default', 1, '2026-03-15', '2026-03-15', 'Original invoice', 'RE-1',
      '2026-03', 2026, 'posted', 'outgoing_invoice', '${legacySourceKey ? 'outgoing_invoice:invoice-1' : 'outgoing-invoice:invoice-1'}', datetime('now'));
