                    ...
                    <div className="flex items-center gap-2">
                        ...
                        <button
                            ...
                            className={`px-3 py-1.5 rounded-full text-xs font-bold border transition-colors duration-150 ease-out ${
                                em.isDefaultBilling ? 'bg-foreground text-white border-foreground' : 'bg-surface text-foreground border-border hover:bg-surface-muted'
                            }`}
                        >
                        ...
                        <button
                            ...
                            className={`px-3 py-1.5 rounded-full text-xs font-bold border transition-colors duration-150 ease-out ${
                                em.isDefaultGeneral ? 'bg-foreground text-white border-foreground' : 'bg-surface text-foreground border-border hover:bg-surface-muted'
                            }`}
                        >
