        ...
        <div className="p-4 space-y-2">
          {eurItems.map((item) => {
            ...
            return (
              <div
                key={key}
                className={`p-3 rounded-xl border transition-colors duration-150 ease-out ${isActive ? 'border-foreground bg-surface-muted' : 'border-border hover:border-muted/30'}`}
              >
