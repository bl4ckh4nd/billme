        ...
        <div className="mt-2 flex items-center gap-3">
          ...
          {selectedImportAccount && (
            <>
              ...
              <div className="rounded-xl border border-border bg-surface px-3 py-2 text-xs font-mono text-muted">
                Standard SKR: {formatEmptyValue(selectedImportAccount.defaultSkrAccountNumber)}
              </div>
            </>
          )}
        </div>
              ...
              <div key={account.id} className="flex flex-wrap items-center justify-between gap-3 rounded-xl border border-border bg-surface-muted p-4">
                <div>
                  ...
                  <p className="text-xs text-muted mt-1">
                    Standard SKR ({activeChart}): {formatEmptyValue(account.defaultSkrAccountNumber)}
                  </p>
                </div>
                <div className="flex items-center gap-3">
                  <select
                    ...
                    className="rounded-lg border border-control-border bg-surface px-3 py-1.5 text-xs font-mono tabular-nums disabled:opacity-50 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-focus-ring"
                  >
