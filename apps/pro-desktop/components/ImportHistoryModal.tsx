...
export const ImportHistoryModal = ({ isOpen, onClose, accountId }: ImportHistoryModalProps) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-foreground/50">
      <div className="bg-surface rounded-xl shadow-2xl w-[95%] h-[85vh] flex flex-col">
        {/* Header */}
          ...
          <div className="w-1/3 border-r border-border overflow-y-auto p-4 space-y-2">
            ...
            {batches.map((batch) => (
              <button
                ...
                className={`w-full text-left p-4 rounded-lg border-2 transition-colors duration-150 ease-out ${
                  ...
                  <div className="border-t border-border pt-6">
                    ...
                    {details.canRollback && !showRollbackConfirm && (
                      <button
                        ...
                        className="flex items-center gap-2 px-4 py-2 bg-error-bg text-error rounded-lg hover:bg-error-bg/80 transition-colors duration-150 ease-out font-medium"
                      >
                        <Undo2 size={16} />
                      ...
                      <div className="bg-error-bg border border-error/30 rounded-lg p-4">
                        ...
                        <div className="mb-4">
                          ...
                          <textarea
                            ...
                            className={`w-full px-3 py-2 border rounded-lg focus:ring-2 focus:border-transparent resize-none transition-colors duration-150 ease-out ${
                        ...
                        <div className="flex gap-2">
                          <button
                            ...
                            className="px-4 py-2 bg-error text-white rounded-lg hover:bg-error/90 disabled:opacity-50 disabled:cursor-not-allowed transition-colors duration-150 ease-out font-medium"
                          >
                          ...
                          <button
                            ...
                            className="px-4 py-2 bg-canvas text-muted rounded-lg hover:bg-canvas transition-colors duration-150 ease-out"
                          >
                            Abbrechen
                          </button>
                        </div>
