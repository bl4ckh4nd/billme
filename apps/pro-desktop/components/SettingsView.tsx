...
export const SettingsView: React.FC = () => {
      ...
      case 'numbers':
        return (
          <NumbersTab
            ...
            nextCustomerPreview={nextCustomerPreview}
      ...
      case 'dunning':
        return (
          <DunningTab
            ...
            previewLevelIndex={previewLevelIndex}
  ...
  return (
    <div className="bg-surface rounded-xl shadow-sm min-h-full flex overflow-hidden relative animate-enter">

      {/* Toast */}
      {showSaveToast && (
        <div className="absolute top-8 right-8 bg-foreground text-accent px-6 py-3 rounded-full shadow-2xl flex items-center gap-3 z-50 animate-in fade-in slide-in-from-top-4">
          <CheckCircle size={18} />
                ...
                {group.items.map((item) => {
                  ...
                  return (
                    <button
                      ...
                      className={`w-full text-left p-3 rounded-xl flex items-center gap-3 transition-[background-color,border-color,color,box-shadow,transform,opacity] duration-200 ease-out group ${
                        isActive
      ...
      <div className="flex-1 flex flex-col h-full">
         ...
         <div className="p-8 border-t border-border-subtle flex justify-end bg-surface rounded-b-2xl">
             <button
                onClick={handleSave}
                className="bg-foreground text-accent px-8 py-3 rounded-xl font-bold text-sm hover:scale-105 active:scale-95 transition-[background-color,border-color,color,box-shadow,transform,opacity] ease-out flex items-center gap-2 shadow-xl shadow-black/10"
             >
                 <Save size={18} />
