...
export const getDisplayLineTotal = (item: Pick<LineItem, 'quantity' | 'price' | 'total'>) => {
...
export const getDunningBadge = (level: number | undefined) => {
    ...
    return <span className={`px-2 py-1 rounded-sm text-[10px] font-bold border ${colorClass} uppercase tracking-wide flex items-center gap-1 whitespace-nowrap`}>
