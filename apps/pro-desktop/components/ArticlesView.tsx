        ...
        <div className="flex-1 bg-surface rounded-xl p-8 min-h-full shadow-sm flex flex-col overflow-hidden relative">
            ...
            {articles.length === 0 ? (
                <div className="flex-1 flex flex-col items-center justify-center gap-4 text-center py-16">
                    ...
                    <div>
                        <h3 className="font-bold text-lg text-foreground mb-1">Noch keine Artikel</h3>
                        <p className="text-sm text-muted max-w-xs">Fügen Sie Ihren ersten Artikel oder Ihre erste Leistung hinzu, um loszulegen.</p>
                    </div>
                    <button
                        onClick={() => handleOpenForm()}
                        className="px-5 py-2.5 bg-foreground text-surface rounded-lg font-bold text-sm hover:bg-dark-1 transition-[background-color,border-color,color,box-shadow,transform,opacity] duration-150 ease-out"
                    >
                ...
                <div className="flex-1 flex flex-col items-center justify-center gap-4 text-center py-16">
                    ...
                    <div>
                        <h3 className="font-bold text-lg text-foreground mb-1">Keine Treffer</h3>
                        <p className="text-sm text-muted max-w-xs">Keine Artikel entsprechen der aktuellen Suche oder dem gewählten Filter.</p>
                    </div>
                    <button
                        onClick={() => { setSearchTerm(''); setSelectedCategory('Alle'); }}
                        className="px-5 py-2.5 bg-canvas border border-border rounded-lg font-bold text-sm text-foreground hover:bg-border transition-[background-color,border-color,color,box-shadow,transform,opacity] duration-150 ease-out"
                    >
                        Filter zurücksetzen
                    </button>
                </div>
