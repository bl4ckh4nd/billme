      ...
      <div className="bg-surface-muted rounded-xl p-6 border border-border-subtle flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        ...
        <div className="flex gap-3">
          <button
            ...
            className="px-5 py-3 rounded-xl font-bold bg-surface border border-border hover:bg-canvas transition-colors duration-200 ease-out"
          >
            Verify
          </button>
          <button
            ...
            className="px-5 py-3 rounded-xl font-bold bg-foreground text-white hover:bg-dark-1 transition-colors duration-200 ease-out"
          >
            Export CSV
          </button>
        </div>
        ...
        <div className="flex flex-col sm:flex-row gap-3">
          ...
          <div className="flex-1 flex gap-2">
            <input
              ...
              className="flex-1 bg-surface border border-border rounded-lg p-3 text-sm font-medium outline-none focus:ring-2 focus:ring-accent transition-shadow duration-200 ease-out"
            />
            <button
              onClick={async () => {
                try {
