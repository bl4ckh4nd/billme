        ...
        <div className="bg-surface-muted border border-border rounded-xl p-6 space-y-5">
          ...
          <div>
            ...
            <input
              ...
              className="w-48 bg-surface border border-border rounded-md px-3 py-2 text-sm font-bold focus:ring-2 focus:ring-accent outline-none transition-shadow duration-200 ease-out"
            />
          </div>
          ...
          <button
            ...
            className="w-full px-4 py-3 bg-warning text-black rounded-xl hover:bg-warning/80 disabled:opacity-50 disabled:cursor-not-allowed transition-colors duration-200 ease-out text-sm font-bold flex items-center justify-center gap-2"
          >
            <Megaphone size={16} />
      ...
      {dunningEnabled && (
        <div className="space-y-3">
          ...
          {settings.dunning.levels.map((level, index) => (
            <div
              key={level.id}
              className={`bg-surface border rounded-xl overflow-hidden transition-[background-color,border-color,color,box-shadow,opacity,transform,width] duration-200 ease-out ${
                level.enabled ? 'border-border hover:border-muted/50' : 'border-border-subtle opacity-50'
              }`}
            >
                ...
                <div className="flex items-center gap-4 text-xs">
                  <div className="flex items-center gap-1.5">
                    ...
                    <input
                      ...
                      className="w-14 bg-surface border border-border rounded-sm px-2 py-1 text-center font-bold tabular-nums focus:ring-2 focus:ring-accent outline-none disabled:opacity-50 transition-shadow duration-200 ease-out"
                    />
                  ...
                  <div className="flex items-center gap-1.5">
                    ...
                    <input
                      ...
                      disabled={!level.enabled}
                      className="w-16 bg-surface border border-border rounded-sm px-2 py-1 text-center font-bold tabular-nums focus:ring-2 focus:ring-accent outline-none disabled:opacity-50 transition-shadow duration-200 ease-out"
                    />
                ...
                <div className="p-4 space-y-3">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full bg-surface-muted border border-border rounded-md px-3 py-2 text-sm font-medium focus:ring-2 focus:ring-accent outline-none transition-shadow duration-200 ease-out"
                  ...
                  <div>
                    <div className="flex items-center justify-between mb-1.5">
                      ...
                      <button
                        ...
                        className="px-2.5 py-1 bg-canvas hover:bg-surface-muted text-muted rounded-sm text-[10px] font-bold transition-colors duration-200 ease-out"
                      >
                        Vorschau
                      </button>
                    </div>
                    <textarea
                      ...
                      className="w-full bg-surface-muted border border-border rounded-md px-3 py-2 text-sm font-medium focus:ring-2 focus:ring-accent outline-none resize-none transition-shadow duration-200 ease-out"
                      ...
                      <div className="flex flex-wrap gap-1">
                        {[
                          ...
                          <button
                            ...
                            className={`px-1.5 py-1 rounded-sm text-[10px] font-bold transition-colors duration-200 ease-out ${
                              ph.present
