...
export const PRO_MOCK_INVOICES: Invoice[] = MOCK_INVOICES.map(
  ({ taxMode: _taxMode, ...invoice }) => invoice,
);

export const PRO_MOCK_ACCOUNTS: Array<Account & { defaultSkrAccountNumber: string }> =
